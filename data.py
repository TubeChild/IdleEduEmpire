...
CW_SHOP: list[dict] = [
    ...
    {"id": "cw_click_2", "name": "Cosmic Click II",
     ...
     "section": "Multiversal Powers"},
    # ── Interzone Bonds ───────────────────────────────────────────────────────
    {"id": "cw_shared_1", "name": "Shared Curriculum I",
     "cost": 12, "desc": "Each unlocked zone adds +3% KP/s to Zone 1.",
     "effect": "interzone_bonus", "value": 0.03, "req": None,
     "section": "Interzone Bonds"},
    {"id": "cw_shared_2", "name": "Shared Curriculum II",
     "cost": 30, "desc": "Each unlocked zone adds +6% KP/s to Zone 1 instead.",
     "effect": "interzone_bonus", "value": 0.06, "req": "cw_shared_1",
     "section": "Interzone Bonds"},
    {"id": "cw_echo", "name": "Zone Echo",
     "cost": 20, "desc": "Zone 1 energy radiates outward: all other zones gain +5% KP/s.",
     "effect": "zone_echo", "value": 1.05, "req": None,
     "section": "Interzone Bonds"},
    # ── Prestige Chain ────────────────────────────────────────────────────────
    {"id": "cw_honor_eff", "name": "Honor Resonance",
     "cost": 15, "desc": "Diplomas needed per Honor reduced by 20%.",
     "effect": "honor_rate_bonus", "value": 0.80, "req": None,
     "section": "Prestige Chain"},
    {"id": "cw_endow_eff", "name": "Endowment Wave",
     "cost": 25, "desc": "Honors needed per Endowment reduced by 25%.",
     "effect": "endow_rate_bonus", "value": 0.75, "req": "cw_honor_eff",
     "section": "Prestige Chain"},
    {"id": "cw_alumni_eff", "name": "Alumni Legacy",
     "cost": 35, "desc": "Endowments needed per Alumni Point reduced by 33%.",
     "effect": "alumni_cost_mult", "value": 0.67, "req": "cw_endow_eff",
     "section": "Prestige Chain"},
    # ── Celestial Events ──────────────────────────────────────────────────────
    {"id": "cw_event_freq", "name": "Principal's Network",
     "cost": 8,  "desc": "Events spawn 25% faster.",
     "effect": "event_timer_mult", "value": 0.75, "req": None,
     "section": "Celestial Events"},
    {"id": "cw_rare_boost", "name": "Rare Book Collection",
     "cost": 18, "desc": "Rare events are twice as likely.",
     "effect": "rare_weight_bonus", "value": 2.0, "req": None,
     "section": "Celestial Events"},
    # ── Spirit Teachers ───────────────────────────────────────────────────────
    {"id": "st_vygotsky", "name": "Lev Vygotsky",
     "cost": 20, "desc": "Combo window 50% longer. Combo multiplier ×1.5.",
     "effect": "spirit_teacher", "value": "vygotsky", "req": None,
     "section": "Spirit Teachers",
     "quote": "What a child can do with help today, she will do alone tomorrow."},
    {"id": "st_dewey", "name": "John Dewey",
     "cost": 20, "desc": "Each click triggers a 5-second +15% KPS burst.",
     "effect": "spirit_teacher", "value": "dewey", "req": None,
     "section": "Spirit Teachers",
     "quote": "Education is not preparation for life — it is life itself."},
    {"id": "st_ellen_key", "name": "Ellen Key",
     "cost": 25, "desc": "All Zone 1 buildings produce 20% more KP/s.",
     "effect": "spirit_teacher", "value": "ellen_key", "req": None,
     "section": "Spirit Teachers",
     "quote": "The child is the soul of the future."},
    {"id": "st_montessori", "name": "Maria Montessori",
     "cost": 25, "desc": "Offline earnings efficiency ×1.5.",
     "effect": "spirit_teacher", "value": "montessori", "req": None,
     "section": "Spirit Teachers",
     "quote": "Success: the children are working as if I did not exist."},
    {"id": "st_sun_tzu", "name": "Sun Tzu",
     "cost": 30, "desc": "+30% Diplomas earned per prestige.",
     "effect": "spirit_teacher", "value": "sun_tzu", "req": None,
     "section": "Spirit Teachers",
     "quote": "In the midst of chaos, there is also opportunity."},
    {"id": "st_freire", "name": "Paulo Freire",
     "cost": 30, "desc": "Events give +40% rewards and spawn 20% sooner.",
     "effect": "spirit_teacher", "value": "freire", "req": None,
     "section": "Spirit Teachers",
     "quote": "Education is either an instrument of freedom or of oppression."},
    {"id": "st_socrates", "name": "Socrates",
     "cost": 35, "desc": "Quiz rewards are doubled.",
     "effect": "spirit_teacher", "value": "socrates", "req": None,
     "section": "Spirit Teachers",
     "quote": "I cannot teach anybody anything — I can only make them think."},
    {"id": "st_piaget", "name": "Jean Piaget",
     "cost": 40, "desc": "Each Zone 1 prestige adds +5% KPS (compounding).",
     "effect": "spirit_teacher", "value": "piaget", "req": None,
     "section": "Spirit Teachers",
     "quote": "The goal of education is not more knowledge, but the ability to invent."},
    # ── Campus Themes ─────────────────────────────────────────────────────────
